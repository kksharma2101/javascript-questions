...
// 6.== Given a and b, your function should return the value of ab. Example:
...
//   let area = (3 * Math.sqrt(3) * Math.pow(val, 2)) / 2;
//   return area;
// }
...
// 9.== Given n numbers, your function should return the minimum of them all. The number of parameters won't be accepted from user. Example:
...
// 10.== Given three angles of a triange, your function should return if it is a scalene, isosceles, equilateral triangle or not a triangle at all. Example:
...
// 11.== Given an array and an item, your function should return the index at which the item is present. Example: Input: indexOf([1,6,3,5,8,9], 3) ––> Output: 2
